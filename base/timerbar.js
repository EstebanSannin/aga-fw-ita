...
/*var action=function()
{
   alert("Gateway has been rebooted!\nU.S. Robotics recommends you refresh your browser.");
   
   var loc = 'info.html';  //USR9106 Reflash only current HTML frame
...
if(ns4){
   ...
   txt+='<div id="PBouter" onmouseup="hidebar()" style="position:relative; left:260px; visibility:hidden; background-color:'+bordercolor+'; width:'+barwidth+'px; height:'+barheight+'px;">';
